...
<template>
	<div class="teamcss">
		...
		<div class="col-md-12" v-if="viewno==1">
			<div class="">
				<group-teams :groupno="3" :users=users></group-teams>
				<group-teams :groupno="2" :users=users></group-teams>
			</div>
		</div>
		<div class="col-md-12" v-if="viewno==1">
			<div class="">
				<group-teams :groupno="1" :users=users></group-teams>
				<group-teams :groupno="4" :users=users></group-teams>
			</div>
		</div>
 	</div>
 	</template>
	...
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
		<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641529391" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
		<iframe src="https://player.vimeo.com/video/641523083" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>	
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641529334" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641518247" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641518329" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641513209" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641514142" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641517185" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641515463" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/641512426" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
	</div>
	<!-- <div class="col-md-6 col-sm-3 embed-responsive embed-responsive-16by9 personvideo">
...
export default {
	mixins:[Constants],
	components:{GroupTeams,StripeVueCard,PaymentSelecter},
	data(){
		return{
			selectgroupflag:0,
			users:[],
	...
	methods:{
		votingmember(){
			axios.post('voting/list')
            .then(response=>this.processvotingResponse(response.data))
            .catch(error=>console.log(error));
		},
		processvotingResponse(data){
			//this.votingmembers =data;
